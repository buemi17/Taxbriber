...
cardNames = {
  ...
  "Attack Modifier (+0) muddle",
  "Attack Modifier (+0) muddle",
  "Attack Modifier (+1) ((shield)1) rolling",
  "Attack Modifier (+1) ((shield)1) rolling",
  "Attack Modifier (+1) (You may (icon) one ally to add +2 to the attack)",
  "Attack Modifier (+1) (You may (icon) one ally to add +2 to the attack)",
  "Attack Modifier (+1) (You may (icon) one ally to add +2 to the attack)",
  "Attack Modifier (+2) (Gain one loot token)",
  "Attack Modifier (+2) (Gain one loot token)",
  "Attack Modifier (+2) (Gain one loot token)",
  "Attack Modifier stun rolling",
  "Attack Modifier (+3)",
  "Attack Modifier (+3)",
}
cardDescriptions = {
