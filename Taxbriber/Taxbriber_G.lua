masteryPos = {
  ...
  [1] = {x=-0.6783017030913254, y=0.11, z=0.6849209348495071},
  ...
  [2] = {x=-0.6783017030913254, y=0.11, z=0.7895417745222229},
}
perkPos = {
  --[][]Replace two [-1] cards with two [+0] muddle cards
  [1] = {x=0.16310438476759803, y=0.11, z=-0.6250751345899652},
  [2] = {x=0.20780263958306155, y=0.11, z=-0.6250751345899652},
  --[][] Replace one [+0] card with one [+1] "[shield]1" rolling card
  [3] = {x=0.16310438476759803, y=0.11, z=-0.4957147295120339},
  [4] = {x=0.20780263958306155, y=0.11, z=-0.4957147295120339},
  --[][][] Replace one [+0] card with one [+1] "You may [icon] one ally to add +2 to the attack" card
  [5] = {x=0.16310438476759803, y=0.11, z=-0.36635410929669},
  [6] = {x=0.20780263958306155, y=0.11, z=-0.36635410929669},
  [7] = {x=0.25250089439852486, y=0.11, z=-0.36635410929669},
  --[][][] Add one [+2] "Gain one loot token" card
  [8] = {x=0.16310438476759803, y=0.11, z=-0.13547885715564248},
  [9] = {x=0.20780263958306155, y=0.11, z=-0.13547885715564248},
  [10] = {x=0.25250089439852486, y=0.11, z=-0.13547885715564248},
  --[]Add one stun rolling card
  [11] = {x=0.16310438476759803, y=0.11, z=-0.00735205000137687},
  --[][] Add one [+3] card
  [12] = {x=0.16310438476759803, y=0.11, z=0.07001760254309627},
  [13] = {x=0.20780263958306155, y=0.11, z=0.07001760254309627},
  --[] Ignore item [-1card] effects and remove one [-1] card
  [14] = {x=0.16310438476759803, y=0.11, z=0.14738725508756964},
  --[] At the start of the scenario gain one loot token
  [15] = {x=0.16310438476759803, y=0.11, z=0.27632921789805587},
  --[] Once per scenario, when you suffer damage from attack, you may [icon] attacking enemy to negate the damage
  [16] = {x=0.16310438476759803, y=0.11, z=0.40322242712865575},
  --[|] Whenever you short rest you may [icon] one ally to gain all the benefits of a long rest
  [17] = {x=0.16310438476759803, y=0.11, z=0.6324453163724735},
  [18] = {x=0.16310438476759803, y=0.11, z=0.6611211795809153},
  --
}
